              ...
              child:  SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(num1,),
                      ListTile(
                        title: Icon(Icons.shop_2, size: 45.0, color: Colors.deepPurple,),
              ...
              child: SizedBox(width: 110, height: 110, 
                child: Column(
                  children: [
                    Text(num2),
                    ListTile(
                      title: Icon(Icons.people, size: 45.0, color: Colors.deepPurple,),
          ...
          children: [
            ...
            child: Column(
                ...
                children: [
                  ...
                  child: ListTile(
                    title: Icon(Icons.location_city_sharp, size: 45.0, color: Colors.deepPurple,),
